...
#
# WORM object storage is not provisioned here: bring an S3-compatible bucket
# with Object Lock (the ../aws root creates one) or accept the local
# document volume for non-WORM pilots (docs/05-deployment.md).
