...
- **Queue-side document preview** — shipped as a scoped read of the signed
  ...
  preview as a download offer) and the broader auditor UX.
...
Nothing is queued: queue-side document preview, the last candidate pulled
from the "what remains" notes, shipped 2026-07-12 (ADR-0027). Remaining
candidates live in the notes above — auditor UX, site-side depth,
