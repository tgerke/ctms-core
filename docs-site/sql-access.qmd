...
| --- | --- |
| `v_expected_document_status` | Every expected document with derived status: `missing`, `pending_review`, `current`, `expiring_soon`, `expired`, `superseded` |
| `v_study_site_completeness` | Per-site rollup: counts by status, percent current |
