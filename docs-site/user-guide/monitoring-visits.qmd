...
| **Overdue** | The scheduled date passed with no visit recorded | Conduct the visit, or reschedule it |
...
Upload the trip report from the visit page. The report is a real document —
it gets the same version history and signatures as everything else — and the
