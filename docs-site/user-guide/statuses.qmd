...
| **Pending review** (blue) | Uploaded, awaiting an approval signature | Review the file and approve it, or upload a corrected version |
...
| **Awaiting report** (amber) | Conducted, no trip report yet |
