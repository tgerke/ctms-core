...
- A **site page** (click any site) holds the site's staff, visits, issues,
  enrollment reporting, and its expected documents grouped by TMF zone, each
  with an upload button where one is needed.
