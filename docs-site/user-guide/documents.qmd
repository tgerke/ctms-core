...
every document's title, TMF artifact, site, person, uploader, and file
names. Every word you type must match, which makes narrowing natural: "1572"
lists every Form FDA 1572, "1572 003" is site 003's. Artifact codes, site
numbers, and people's names all work. Search covers the document *metadata*
— what a document is, where it belongs, who it's about — not the text inside
the files.
