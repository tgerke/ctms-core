...
| §11.10(g) authority checks | Role-based grants (admin / trial_ops / monitor / read_only / ingest over read / upload / sign / approve / administer, scoped to study or site; ingest is the machine-identity role for source-system filing, ADR-0011) enforced per route; grant changes are themselves audited. Actor identity bound per transaction |
